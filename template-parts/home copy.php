...
<div class="home-content">
    <!-- Banner Principal -->
    <section class="mm-home-Nobanner"
        style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/home.webp');"
        role="banner">
        <div class="mm-home-Nobanner__overlay">
            <div class="home-container">
                <div class="mm-home-Nobanner__content">
                    <h1 class="mm-home-Nobanner__title">
                        Masajes Profesionales para Hombres
                    </h1>
                    <p class="mm-home-Nobanner__subtitle">
                        ¿Listo para tu experiencia de bienestar?
                    </p>
                    <p class="mm-home-Nobanner__description">
                    ...
                    <div class="mm-home-Nobanner__cta">
                    ...
                    <div class="mm-home-Nobanner__info">
